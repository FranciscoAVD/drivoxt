  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        caption_label: "text-lg lg:text-base font-medium",
        ...
        head_row: "flex gap-x-2 lg:gap-x-1",
        head_cell:
          "text-gray-500 text-lg lg:text-sm rounded-md w-8 font-normal text-[0.8rem] dark:text-gray-400",
        row: "flex gap-2 lg:gap-1 w-full mt-2",
        cell: cn(
        ...
        day: cn(
          ...
          "h-8 w-8 p-0 text-xl lg:text-base font-normal aria-selected:opacity-100"
        ),
        day_range_start: "day-range-start",
        day_range_end: "day-range-end",
        day_selected:
          "bg-accent text-gray-50 hover:bg-accent/80 hover:text-gray-50 focus:bg-accent focus:text-gray-50",
